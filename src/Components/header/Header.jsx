...
function Header() {
    ...
    const headerInfo = [
        { title: 'امتیاز دهی به استاد ها', describtion: 'به استاد ها امتیاز بدهید و نظر خود را درباره تدریس آنها بگویید', btnText: 'ورود به بخش استاد ها', img: '/images/star.png',link: '/ostads/' },
        ...
        { title: 'ساعت کلاس ها', describtion: 'از زمان های حضور و ساعت برگزاری کلاس استاد مورد نظر خود با خبر شوید', btnText: 'ورود به بخش استاد ها', img: '/images/clock.png',link: '/ostads/' },
    ...
    return (
        <header className="relative bg-[#0056AA] flex items-start w-full h-[30vh] md:h-[45vh] md:mt-4 rounded-lg overflow-hidden">
            <div className="w-3/4 flex flex-col gap-4 p-8 md:p-12 text-indigo-200 z-50">
            ...
            <Image
                ...
                className='absolute w-64 md:w-104 -left-10 -bottom-5 md:left-40 md:-bottom-10'
                alt='baner image'
                width={300}
                height={300}
            />
